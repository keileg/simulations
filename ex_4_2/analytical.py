"""
Extracts pressure, displacement and boundary conditions from the
analytical soultion. The output is a dictionary containing the named
variables for all discrete times.
...
def extract_exact_data(
    grid_object, data_dictionary, parameter_keyword_flow, parameter_keyword_mechanics
):
    """
    ...
    mandel_dict = {
        "pressure": np.zeros((len(times), g.num_cells)),
    ...
    OBS: We find the roots using the bisection method. Thanks to Manuel
    Borregales who helped with the implementation of this part of the code.
    """
